...
import i1 from "../../src/Assests/women/w1.png"; 
import i2 from "../../src/Assests/women/Sarees1.png"; 
import i3 from "../../src/Assests/women/Gown1.png"; 
...
function Womencollection() {
    ...
    let FemaleClothItems = clothItems.filter(item => item.gender === "Female")
    console.log(FemaleClothItems);

    return (
        <div>
            <div className="flex flex-row  ml-24 overflow-x-auto space-x-2 justify-center">
                {FemaleClothItems.map((item, index) => (
