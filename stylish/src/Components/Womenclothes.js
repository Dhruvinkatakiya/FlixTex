...
import i1 from "../../src/Assests/women/w4.png"; 
import i2 from "../../src/Assests/women/w5.png"; 
import i3 from "../../src/Assests/women/Sarees1.png"; 
import i4 from "../../src/Assests/women/Gown1.png"; 
...
function Womenclothes() {
  ...
  let femaleClothData = clothesData.filter(item => item.Gender === "Female");

  return (
    <div className="flex flex-wrap justify-center">
      {femaleClothData.map((item, index) => (
        <div key={index} className="group my-10 mx-4 flex w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md transition duration-300 ">
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <div className="mt-2 mb-3 flex items-center justify-between">
              <p>
                <span className="text-xl font-semibold text-gray-800">₹{item.DiscountPrice}</span>
                <span className="text-sm text-gray-500 line-through">₹{item.MRP}</span>
              </p>
              <div className="flex items-center space-x-2">
                <select className="border border-gray-300 rounded-md px-3 m-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
